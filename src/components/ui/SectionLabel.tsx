...
export function SectionLabel({ number, title, className, variant = "light" }: Props) {
  ...
  return (
    <motion.div
      ...
      className={`flex items-center gap-3 text-[11px] uppercase tracking-[0.28em] font-mono ${className ?? ""}`}
    >
